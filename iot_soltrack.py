# -*- coding: utf-8 -*-
"""Copy of IoT Soltrack.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1dRDYxvcoxtRsfpUMoY0cb64vLLR7xuwK
"""
...
def plot_pv_generation(pv_power_dual_axis, pv_power_fixed):
  """
  Gets PV power generation as input and plots DC and AC power generation for the next day
  """
  plt.rcParams['font.size'] = 14
  ax = pv_power_dual_axis['ac'].resample('h').sum().plot(figsize=(15, 10), label='Dual axis tracked')
  pv_power_fixed['ac'].resample('h').sum().plot(ax=ax, label='Fixed mount')
  plt.title('AC Power')
  plt.ylabel('Output [W]')
  plt.grid()
  plt.legend()

plot_pv_generation(pv_power_dual_axis, pv_power_fixed)

100 * (pv_power_dual_axis['ac'].sum() - pv_power_fixed['ac'].sum()) / pv_power_fixed['ac'].sum()
